...
const CalendarDemo = () => {
    ...
    const handleClick = async () => {
        ...
        const data = await ParametrageService.fusionRep();
        setResultat(data);
        console.log(setGroupedUsers)
        window.location.replace('/pedagogie/fusion-repartition')
    };
        ...
        return (
            <div className="flex align-items-center justify-content-start gap-3 my-2">
                ...
                <Button
                    ...
                    onClick={handleClick}
                    icon="pi pi-merge" 
                    label="Fusionner les répartition" 
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Fusion des répartitions par centre d'ecrit principal et par discipline</h5>
